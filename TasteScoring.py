...
# --------------------------
# 5. COMPUTE REMAINING PAIRS (for anchor logic)
# --------------------------
...
# keep global state of which anchor (fixed product) we’re working on
...
st.markdown("""
You’ll now rate **all combinations for one main product at a time**  
(e.g., *Peanut Butter + X*) — this makes grading faster and more consistent.
""")
...
# --------------------------
# 8. DETERMINE CURRENT ANCHOR AND REMAINING SUB-PAIRS
# --------------------------
if remaining_pairs.empty:
